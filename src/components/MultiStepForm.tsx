...
const MultiStepForm = () => {
  ...
  const generatePDF = () => {
    ...
    // Add title
    doc.setFontSize(20);
    doc.setTextColor(198, 93, 33); // Orange color
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-800 rounded-2xl shadow-xl p-8 animate-fade-in">
          ...
          <div className="min-h-[200px] flex flex-col justify-center">
            ...
            {currentStep === 3 && (
              <div className="space-y-4 animate-fade-in">
                <Label htmlFor="needs" className="text-lg font-medium text-white">Tell us about your needs</Label>
                <Textarea
                  id="needs"
                  ...
                  className={`text-lg min-h-32 bg-gray-700 border-gray-600 text-white placeholder-gray-400 ${errors.needs ? 'border-red-500' : ''}`}
                  autoFocus
                />
                {errors.needs && (
            ...
            {currentStep === 4 && (
              <div className="space-y-6 animate-fade-in">
                <div className="bg-gray-700 rounded-lg p-6 space-y-4">
                  ...
                  <div>
                    <p className="font-medium text-gray-300">Needs:</p>
                    <p className="text-gray-400">{formData.needs}</p>
                  </div>
                </div>
                <Button
                  onClick={generatePDF}
